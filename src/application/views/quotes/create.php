...
<section id="list">
    <div class="container-fluid">
        <div class="d-flex flex-row justify-content-center">
            <div class="card">
                <?= form_open('quotes/create/' . $type, ['id' => 'orderForm']); ?>
                    <?php if( ! is_null($customer->get_id()) ): ?>
                        <?= form_hidden('customer_id', (int)$customer->get_id()); ?>
                    <?php endif; ?>
                    <div class="card-body mb-3">
                        <h5 class="card-title text-center py-3">Create Quote</h5>
                        <div class="container">
                            <div class="form-row pt-3">
                                <div class="col-4 align-self-center">
                                    <label class="font-weight-bold" for="date">Quote Date / Time</label>
                                </div>
                                <div class="col-4">
                            ...
                            <div class="form-row pt-3">
                                <div class="col-4"></div>
                                <div class="col-4"><small class="form-text text-muted">Select the date and time of the quote.</small></div>
                                <div class="col-3"></div>
                            </div>
                            <div class="form-row pt-3">
                                <div class="col-4 align-self-center">
                            ...
                            <div class="form-row pt-3">
                                <div class="col-4 align-self-center">
                                    <label class="font-weight-bold" for="attn">Attention</label>
                                </div>
                                <div class="col-8">
                                    <input type="text" name="attn" id="attn" class="form-control"  placeholder="" value="<?= ( ! is_null($customer->get_name())) ? $customer->get_name() : 'Select a Customer'; ?>">
                                    <small class="form-text text-muted pl-1">This field is the name of the person who requested the order.</small>
                                </div>
                            </div>
                            <div class="form-row pt-3">
                                <div class="col-4 align-self-center">
                                    <label class="font-weight-bold" for="type_display">Quote Type</label>
                                </div>
                                <div class="col-8">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="card mt-3 mb-3">
                            <div class="card-body">
                                ...
                                <div id="cart"></div>
                                <div class="d-flex justify-content-center">
                                    <button type="button" onclick="cart.postData();" class="btn btn-success mb-2 gbr-btn">Submit Quote</button>
                                </div>
                            </div>
                        </div>
                    </div>
